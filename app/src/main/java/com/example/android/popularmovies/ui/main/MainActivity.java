...
import com.example.android.popularmovies.data.MovieDataSource;
import com.example.android.popularmovies.model.UserReview;
import com.example.android.popularmovies.ui.auth.LoginActivity;
...
import com.example.android.popularmovies.ui.review.UserReviewsActivity;
...
import com.example.android.popularmovies.utilities.UserReviewListener;
...
public class MainActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FirebaseHelper.init();
        if (FirebaseHelper.getFirebaseAuthObject().getCurrentUser() != null){
            UserReviewListener.listeningToNewReviews();

        }
        //RankingHelper.setInitialBagOfWords();
    ...
    protected void onStart() {
        super.onStart();
        FirebaseUser User = FirebaseHelper.getFirebaseAuthObject().getCurrentUser();
        if (User == null){
            // If the user is not logged in, send user to the Login Activity
            Log.d("samsssssssssssss", "nukkk");
    ...
    private void setSwipeRefreshLayout() {
        ...
        mMainBinding.swipeRefresh.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                if (MovieDataSource.isRecommendations)
                    MovieDataSource.isRecommendations = false;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (id) {
            ...
            case R.id.your_reviews:
                Intent intent2 = new Intent(MainActivity.this, UserReviewsActivity.class);
                startActivity(intent2);
                return true;

            case R.id.action_recommendations:
                MovieDataSource.isRecommendations = true;
                showMovieDataView();
            ...
            case R.id.user_info:
                View view1 = getLayoutInflater().inflate(R.layout.user_dialog, null);
                android.app.AlertDialog.Builder builder = new android.app.AlertDialog.Builder(view1.getContext(), R.style.AlertDialog_Dark);
                builder.setView(view1);
                final TextView name = view1.findViewById(R.id.username);
                final TextView email = view1.findViewById(R.id.user_email);
                ...
                final ValueEventListener valueEventListener = new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        String usermail = (String)reviewData.get("useremail");
