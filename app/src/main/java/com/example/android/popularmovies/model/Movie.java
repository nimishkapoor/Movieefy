...
public class Movie implements Parcelable, Comparable<Movie> {
    ...
    public Movie(int movieId, String originalTitle, String title, String posterPath, String overview,
                 double voteAverage, String releaseDate, String backdropPath, List<Integer> genreIds) {
        mId = movieId;
    ...
    public List<Integer> getmGenreIds(){ return mGenreIds; }
    ...
    private Movie(Parcel in) {
        ...
        score = in.readInt();
        mGenreIds = in.readArrayList(Integer.class.getClassLoader());
    }
    ...
    public int compareTo(@NonNull Movie movie) {
        ...
        return movie.getScore() - this.score;
    }
}
